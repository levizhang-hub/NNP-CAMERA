...
void LED_Init(void)
{
    ...
    HAL_GPIO_Init(GPIOB,&GPIO_Initure);     		//初始化和GPIOB.1
    ...
    GPIO_Initure.Pull=GPIO_PULLUP;         			//上拉
    GPIO_Initure.Speed=GPIO_SPEED_FREQ_VERY_HIGH;  	//高速
    HAL_GPIO_Init(GPIOD,&GPIO_Initure);     		//初始化GPIOH.4
		HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13,GPIO_PIN_SET);	//PH4置1 
    ...
    GPIO_Initure.Pull=GPIO_PULLUP;         			//上拉
    GPIO_Initure.Speed=GPIO_SPEED_FREQ_VERY_HIGH;  	//高速
    HAL_GPIO_Init(GPIOD,&GPIO_Initure);         //始化
